...
impl Parser {
    pub(super) fn statement(&mut self) -> DobraResult<Stmt> {
    ...
    pub(super) fn use_statement(&mut self) -> DobraResult<Stmt> {
        self.advance();
    ...
    pub(super) fn use_name_list(&mut self, clause: &str) -> DobraResult<Vec<String>> {
    ...
    pub(super) fn bind_statement(&mut self, mutable: bool) -> DobraResult<Stmt> {
        self.advance();
    ...
    pub(super) fn func_statement(&mut self) -> DobraResult<Stmt> {
        self.advance();
    ...
    pub(super) fn return_statement(&mut self) -> DobraResult<Stmt> {
        self.advance();
    ...
    pub(super) fn emit_statement(&mut self) -> DobraResult<Stmt> {
        self.advance();
        self.skip_separators();
        Ok(Stmt::Emit(self.expression()?))
    }

    pub(super) fn if_statement(&mut self) -> DobraResult<Stmt> {
        self.advance();
        self.if_tail()
    }

    pub(super) fn if_tail(&mut self) -> DobraResult<Stmt> {
    ...
    pub(super) fn for_statement(&mut self) -> DobraResult<Stmt> {
        self.advance();
    ...
    pub(super) fn while_statement(&mut self) -> DobraResult<Stmt> {
        self.advance();
        let condition = self.expression()?;
        self.skip_newlines();
        let body = self.block()?;
    ...
    pub(super) fn block(&mut self) -> DobraResult<Vec<Stmt>> {
    ...
    pub(super) fn expression_or_assignment_statement(&mut self) -> DobraResult<Stmt> {
    ...
    pub(super) fn for_binding(&mut self) -> DobraResult<ForBinding> {
